    ...
    <SafeAreaView style={styles.signInContainer}>
      <View
        ...
        <View style={styles.backIcon}>
          <Pressable onPress={moveToSignInScreen}>
      ...
      <View
        ...
        <Text style={{color: COLORS.black900}}>Bạn đã có tài khoản</Text>

        <Pressable onPress={moveToSignInScreen}>
          <Text style={{color: COLORS.blue800, marginLeft: 3}}>Đăng nhập</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
